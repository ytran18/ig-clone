...
function More ()
{
    return (
        <div className="w-[238px] h-[264px] shadow-2xl rounded-[10px] bg-white drop-shadow-2xl">
            ...
            <div className="w-full h-[44px] flex justify-between px-3 items-center select-none cursor-pointer hover:bg-[rgb(250,250,250)] rounded-br-[10px] rounded-bl-[10px]">
